...
HTML;
            if ($sPJRegistrationDate > $sNow)
            {
                ...
                echo "<p><strong>Pour les passagers joëlette</strong> les inscriptions seront ouvertes à partir du $sNiceDate.</p>";
            }
            if ($sAARegistrationDate > $sNow)
            {
                $sNiceDate = DBService::FormatDate($sAARegistrationDate);
                echo "<p><strong>Pour les accompagnateurs actifs</strong> les inscriptions seront ouvertes à partir du $sNiceDate.</p>";
            }
            echo
<<<HTML
</div>
